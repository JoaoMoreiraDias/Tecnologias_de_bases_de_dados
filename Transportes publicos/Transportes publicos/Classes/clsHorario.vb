Public Class clsHorario
    ...
    'executa a stored procedure Horarios_ins, insere um horario
    ...
    'executa a stored procedure Horario_del, apaga um horario
    ...
    'executa a stored procedure Horario_edit, edita o horario
