Public Class clsLinha
    ...
    'executa a stored procedure Linha_ins, insere uma linha
    ...
    'executa a stored procedure Linha_del, apaga uma linha
    ...
    'executa a stored procedure Linha_edit, edita a linha
